...
public class ProfileImageController {
    ...
    //프로필 이미지 리스트 얻기
    @GetMapping()
    public ResponseEntity<List<ProfileImageGetResponse>> getList(@Auth AuthUser authUser) {
    ...
    @PutMapping()
    public ResponseEntity<ProfileImageCreateResponse> create(@Auth AuthUser authUser,
